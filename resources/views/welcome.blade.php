...
<body class="antialiased">
    ...
    <div style="text-align: right ; font-size: 30px">
        <a type="button" class="btn-primary" href="{{ route('insert') }}" style="text-decoration: none">Añadir</a>
    </div>
    <div style="margin: 2rem 5rem 0rem 5rem">
        <table class="table" style="text-align: center; flex-direction: row">
            <thead>
                <tr>
                    <th scope="col">Id</th>
            ...
            <tbody style="align-items: center; justify-content: center;">
                @foreach ($personas as $persona)
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="{{ route('delete_person', $persona->id) }}">
                                @csrf
                                <input type="submit" class="btn-danger" value="Eliminar">
                            </form>
                        </td>
                        <td>
                            <form method="GET" action="{{ route('person_update', $persona->id) }}">
                                <input type="submit" class="btn-warning" value="Actualizar">
                            </form>
                        </td>
                    </tr>
                @endforeach
